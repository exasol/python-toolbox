...
from exasol.toolbox.util.dependencies.track_vulnerabilities import SecurityAudit
...
@nox.session(name="security:audit", python=False)
def security_audit(session: Session) -> None:
